...
function seleccionarMokepon(mascotaJugador){
    fetch(`http://192.168.1.8:8080/mokepon/${jugadorId}`, {
         method: "post",
             headers: {
...
function enviarAtaques(){
    ...
    fetch(`http://192.168.1.8:8080/mokepon/${jugadorId}/ataques`, {
        method: "post",
        headers: {
            "Content-Type": "application/json"
        },
...
function obtenerAtaques(){
    ...
    fetch(`http://192.168.1.8:8080/mokepon/${enemigoId}/ataques`)
     .then(function (res) {
        if (res.ok) {
            res.json()
...
function enviarPosicion(x, y){
    fetch(`http://192.168.1.8:8080/mokepon/${jugadorId}/posicion`, {
        method: "post",
        headers: {
            "Content-Type": "application/json"
        },
              ...
              .then(function ({ enemigos }) {
                mokeponesEnemigos = enemigos.map(function (enemigo) {
                    ...
                    if (mokeponNombre === "Hipodoge"){
                        ...
                        mokeponEnemigo = new Mokepon(
                            'Tucapalma', './assets/mokepons_mokepon_tucapalma_attack.png', 5, './assets/mokepons_mokepon_tucapalma_attack.png',
                             enemigo.id)
                    }else if (mokeponNombre === "Pydos"){
                        mokeponEnemigo = new Mokepon(
                            'Pydos', './assets/mokepons_mokepon_pydos_attack.png', 5,'./assets/mokepons_mokepon_pydos_attack.png', 
                            enemigo.id)
                    }else if (mokeponNombre === "Langostelvis"){
                        mokeponEnemigo = new Mokepon(
                            'Langostelvis', './assets/mokepons_mokepon_langostelvis_attack.png', 5, './assets/mokepons_mokepon_langostelvis_attack.png',
                             enemigo.id)
                    }
...
//para cargar todo el html sin importar l lugar donde este
